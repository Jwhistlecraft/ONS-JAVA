		...
		Find.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (SpecificAccount.getText().equals("")) {
						if (Current.getState()) {
							if (Male.getState()) {
								SearchParam = "CM";
							}
						...
						String SpecificFinder = "select * from Accounts where substr(AccNo, 1,2) = '" + SearchParam
								+ "'";
						...
						while (AccountFound.next()) {
							...
							String[] AccountInfo = { AccountAccNo, AccountName, AccountAddress };
						...
						if (AccountFound.next()) {
							...
							AccountInfo.add(new String[] { AccountAccNo, AccountName, AccountAddress });
